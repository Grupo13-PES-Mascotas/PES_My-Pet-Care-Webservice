...
public interface GoogleCalendarDao {
     ...
     * @param accessToken oauth2 token needed to access the Google Calendar
     * @param calendarId Id ofDocument the created calendar
     * @throws CalendarAccessException If an error occurs when accessing the calendar
     */
     ...
     * @param accessToken oauth2 token needed to access the Google Calendar
     * @param calendarId Id ofDocument the calendar to retrieve
     ...
     * @param accessToken oauth2 token needed to access the Google Calendar
     * @param calendarId Id ofDocument the calendar where the event is created
     ...
     * @param accessToken oauth2 token needed to access the Google Calendar
     * @param calendarId Id ofDocument the calendar where the event is located
     ...
     * @param accessToken oauth2 token needed to access the Google Calendar
     * @param calendarId Id ofDocument the calendar where the event is updated
     * @param eventId Id ofDocument the event to update
     ...
     * @param accessToken oauth2 token needed to access the Google Calendar
     * @param calendarId Id ofDocument the calendar where the event is deleted
